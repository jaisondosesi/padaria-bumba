...
<body>
    <header>
        ...
        <div class="title">
            ...
            <br><br><br>
            <a href="criar.php" class="button">Adicionar Produto</a>
                ...
                if ($resultado->num_rows > 0) {
                    while ($row = $resultado->fetch_assoc()) {
                        echo "<div class='card'>
                                ...
                                <a href='editar.php?id={$row['id_produto']}' class='button'>Editar</a>
                                <a href='deletar.php?id={$row['id_produto']}' class='button' onclick=\"return confirm('Tem certeza?');\">Excluir</a>
                              </div>";
                    }
                } else {
